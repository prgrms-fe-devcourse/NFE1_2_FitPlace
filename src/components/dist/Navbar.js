...
var Navbar = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null, nav_on ? (react_1["default"].createElement("div", { className: "w-140 fixed bottom-0 flex flex-col items-center border-2 border-gray-200 border-b-gray-200 drop-shadow-2xl" },
        react_1["default"].createElement("button", { className: "bg-white w-full h-[10px]", onClick: navHandler }),
        react_1["default"].createElement("div", { className: "w-full h-[45px] bg-white flex justify-between items-center px-20" },
            react_1["default"].createElement(react_router_dom_1.Link, { to: "/" },
                react_1["default"].createElement("button", { className: "group" },
            ...
            react_1["default"].createElement(react_router_dom_1.Link, { to: "/profile" },
                react_1["default"].createElement("button", { className: "group" },
                    react_1["default"].createElement("img", { src: My_svg_1["default"], alt: "My", className: "w-9 h-9 transition-transform duration-200 group-hover:scale-125" })))))) : (react_1["default"].createElement("div", { className: "w-140 fixed bottom-0 flex flex-col items-center border-2 border-gray-200 border-b-gray-200 drop-shadow-2xl rounded-xl\t" },
        react_1["default"].createElement("button", { className: "bg-white w-full h-[10px]", onClick: navHandler })))));
};
