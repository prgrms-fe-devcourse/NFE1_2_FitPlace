...
var Navbar = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "w-140 fixed bottom-0 flex flex-col items-center border-2 border-gray-200 border-b-gray-200 drop-shadow-2xl transition-transform duration-300 " + (nav_on ? "translate-y-0 opacity-100" : "translate-y-full opacity-100"), onMouseLeave: handleMouseLeave },
