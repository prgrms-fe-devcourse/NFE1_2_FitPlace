    ...
    <div className='bg-white w-640px h-full' >
      ...
      <form action="#" className='m-5'>
        <div >
          ...
          <input type="text" id='meetName' placeholder='모임 이름을 입력해주세요.' className='border-2 border-solid border-[#e8e8e8] w-96 mt-2.5 text-lg'/>
        </div>
        <div>
          <label htmlFor="meetPersonnel" className='flex font-bold text-xl mt-6'>모임 인원</label>
          <input type="text" id='meetPersonnel' placeholder='모임 인원을 입력해주세요' className='border-2 border-solid border-[#e8e8e8] w-96 mt-2.5 text-lg'/>
        </div>
        <div>
          <h3 className='font-bold text-xl mt-6'>운동 종목</h3>
          <div className='mt-2.5'>
            <label htmlFor="baseball" className=''>야구</label>
            ...
            <label htmlFor="tennis">테니스</label>
        ...
        <div>
          ...
          <input type="text" id='meetexposition' placeholder='모임에 대한 설명을 입력해주세요.' className='border-2 border-solid border-[#e8e8e8] w-full h-32 mt-2.5 text-lg'/>
        </div>
        <div>
          <p className='font-bold text-xl mt-6'>운동장소</p>
          <div className='mt-2.5 border-2 border-solid border-[#e8e8e8] w-96 '>
            <label htmlFor="selectLocation" className='text-[#656565]'>위치 선택</label>
