...
var NotionAdd = function () {
    ...
    var _e = react_1.useState([]),
        imageFiles = _e[0],
        setImageFiles = _e[1]; // 선택된 파일들
    var _f = react_1.useState([]),
        imageUrls = _f[0],
        setImageUrls = _f[1]; // 업로드된 이미지 URL들
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        setImageFiles(function (prev) {
                            return __spreadArrays(prev, newFiles_2);
                        }); // 기존 파일에 추가
                        newUrls_1 = [];
                    ...
                    case 7:
                        setImageUrls(function (prev) {
                            return __spreadArrays(prev, newUrls_1);
                        }); // 기존 URL에 추가
                        setFormData(function (prev) {
                            return __assign(__assign({}, prev), {
                                images: __spreadArrays(prev.images, newUrls_1),
                            });
    ...
    var handleChange = react_1.useCallback(function (e) {
        ...
        setFormData(function (prev) {
            ...
            return __assign(
                __assign({}, prev),
                ((_a = {}),
                (_a[name] = type === "number" ? parseInt(value, 10) : value),
                _a)
            );
        });
    }, []);
    var handleCategorySelect = react_1.useCallback(function (category) {
        setFormData(function (prev) {
            return __assign(__assign({}, prev), { channel: category });
        });
    }, []);
                    ...
                    case 1:
                        ...
                        return [
                            ...
                            fetch(API_URL + "/posts/create", {
                                ...
                                headers: {
                                    Authorization:
                                        "bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyIjp7Il9pZCI6IjY0ZWRiYTRkN2M1NGYyMTI4ZTQ2Y2NlNSIsImVtYWlsIjoiYWRtaW5AcHJvZ3JhbW1lcnMuY28ua3IifSwiaWF0IjoxNzI3Mzk3NTY0fQ.ziDMvpbQF6K61P2POdELAiyLocTIMZ7IZGbe8ZiYlqg",
                                },
                                body: submitData,
                            }),
                        ];
            ...
            react_1["default"].createElement(
                ...
                react_1["default"].createElement(
                    ...
                    react_1["default"].createElement("input", {
                        ...
                        placeholder:
                            "\uBAA8\uC784 \uC774\uB984\uC744 \uC785\uB825\uD574\uC8FC\uC138\uC694.",
                        className:
                            "border-2 border-solid border-[#e8e8e8] w-[600px] h-[45px] mt-2.5 text-lg pl-2.5",
                    })
                ),
                react_1["default"].createElement(
                    "div",
                ...
                react_1["default"].createElement(
                    ...
                    react_1["default"].createElement(
                        "label",
                        {
                            ...
                            className:
                                "flex items-center font-bold text-xl mt-6",
                        },
                        react_1["default"].createElement("input", {
                            type: "checkbox",
                            id: "isTimeFlexible",
                ...
                react_1["default"].createElement(
                    ...
                    react_1["default"].createElement(
                        ...
                        {
                            className:
                                "cursor-pointer relative mt-2.5 border-2 border-solid border-[#e8e8e8] w-[600px] h-[45px] flex items-center px-3",
                    ...
                    react_1["default"].createElement(
                        ...
                        react_1["default"].createElement(
                            "label",
                            {
                                htmlFor: "image",
                                className:
                                    "w-[160px] h-[140px] border-2 border-solid rounded text-[#A7E30A] text-xl flex justify-center items-center relative mt-4",
                            },
                            "+ \uC0AC\uC9C4 \uC5C5\uB85C\uB4DC"
                        ),
                        react_1["default"].createElement("input", {
                ...
                imageUrls &&
                    ...
                    react_1["default"].createElement(
                        ...
                        react_1["default"].createElement(
                            ...
                            {
                                className:
                                    "w-1/2 bg-gray-300 my-3 h-10 text-sm hover:bg-gray-400 hover:rounded-2xl transition-all",
                                onClick: function () {
                                    return setImageUrls([]);
                                },
                            },
