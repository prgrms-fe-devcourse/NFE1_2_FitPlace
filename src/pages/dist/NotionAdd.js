...
var NotionAdd = function () {
    ...
    var _d = react_1.useState([]), channels = _d[0], setChannels = _d[1];
    var _e = react_1.useState(false), isRegistered = _e[0], setIsRegistered = _e[1];
    var _f = react_1.useState(null), newPostId = _f[0], setNewPostId = _f[1];
    ...
    var handleFileChange = react_1.useCallback(function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var files, newFiles, newUrls_1, formData_1, _i, newFiles_1, file, response, data, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
