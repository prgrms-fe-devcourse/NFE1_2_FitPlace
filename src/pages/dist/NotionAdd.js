...
var NotionAdd = function () {
    ...
    var handleTimeFlexibleChange = react_1.useCallback(function (e) {
        var checked = e.target.checked;
        setFormData(function (prev) { return (__assign(__assign({}, prev), { isTimeFlexible: checked, meetingStartTime: checked ? "" : prev.meetingStartTime, meetingEndTime: checked ? "" : prev.meetingEndTime })); });
    }, []);
    var getChannelId = function (selectedChannel) {
        var channel = channels.find(function (ch) { return ch.name === selectedChannel; });
        if (channel) {
            return channel._id;
        }
        var otherChannel = channels.find(function (ch) { return ch.name === "기타"; });
    ...
    var handleSubmit = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    channelId = getChannelId(formData.channel);
            ...
            react_1["default"].createElement("form", { className: "m-5" },
                ...
                react_1["default"].createElement("div", null,
                    react_1["default"].createElement("label", { htmlFor: "isTimeFlexible", className: "flex items-center font-bold text-xl mt-6" },
                        react_1["default"].createElement("input", { type: "checkbox", id: "isTimeFlexible", name: "isTimeFlexible", checked: formData.isTimeFlexible, onChange: handleTimeFlexibleChange, className: "mr-2" }),
                        "\uC2DC\uAC04 \uBB34\uAD00")),
