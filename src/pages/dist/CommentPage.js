    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("div", { className: "relative bg-white w-140 mx-auto min-h-screen flex flex-col" },
            react_1["default"].createElement("div", { className: "flex-grow p-3" },
                ...
                react_1["default"].createElement("div", { className: "flex-grow overflow-y-auto max-h-full" }, Post ? (Post.comments.map(function (item, idx) { return (react_1["default"].createElement("div", { key: idx, className: "bg-gray-100 w-full rounded-md shadow-lg mb-5 p-4 flex flex-col" },
